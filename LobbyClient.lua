-- LobbyClient.lua (LocalScript)
-- Path: StarterPlayer.StarterPlayerScripts.LobbyClient
-- This script will handle the creation and management of the Lobby UI.
...
buttonLayout.From = Enum.UIListLayout.From.Bottom
